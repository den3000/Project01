...
- **demo**: [project-fs](demo/project-fs/README.md) — ассистент по файлам чужого проекта (4 сценария, профили нарезаны по фазам = так настраивается судья, projectfs-mcp + git-mcp, глобальных правил ноль)
