package ru.den.writes.code.agenticHub.features.llm.openrouter

/**
 * Typed OpenRouter model identifier.
 *
 * Mirrors [ru.den.writes.code.agenticHub.features.llm.gemini.GeminiModel] in shape: a small [Known] catalog plus a
