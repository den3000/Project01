package ru.den.writes.code.agenticHub.features.llm.huggingface

/**
 * Typed Hugging Face Inference Providers model identifier.
 *
 * Mirrors [ru.den.writes.code.agenticHub.features.llm.gemini.GeminiModel] / [ru.den.writes.code.agenticHub.features.llm.openrouter.OpenRouterModel] in shape: a small [Known]
